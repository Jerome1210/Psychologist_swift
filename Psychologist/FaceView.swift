...
//Will show the code on the view to preview
@IBDesignable
class FaceView: UIView {
	...
	private struct Scaling {
		...
		static let FaceRadiusToMouthOffsetRadius: CGFloat = 3
	}
	...
	private func bezierPathForSmile(fractionOfMaxSmile: Double) -> UIBezierPath {
		...
		let mouthVerticalOffset = faceRadius / Scaling.FaceRadiusToMouthOffsetRadius
